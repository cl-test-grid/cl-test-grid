...
** TODO how to make the development tasks/questions more visible 
   for other people? Today github displays TODO.org very
   ugly, so that only people who will checkout the soruces
   and open TODO.org in emacs could understand open
   questions.
** TODO new status, :expected-failure

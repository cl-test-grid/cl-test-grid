...
+ cl-custom-hash-table-test 2015-01-13
...
+ doplus 2013-04-20
+ drakma 2013-03-12+ (implemented trivial testsuite myself, will be captured by the next quicklisp version)
...
+ trivial-gray-streams 2013-03-12+ (implemented testsuite myself, will be captured by the next quicklisp version)

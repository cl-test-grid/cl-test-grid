...
** TODO National characters in DB: ensure DB and transactions are saved/read using utf-8
...
** TODO Install more Lisps on cl-test-grid.cloud.efficito.com machine, as my Linux server is not available anymore.
* Engage People (ideas)

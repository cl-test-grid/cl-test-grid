...
(:SYSTEM->DEPENDENCIES
 (("3b-swf" "alexandria" "chipz" "cl-jpeg" "cxml" "flexi-streams"
  ...
  ("asdf-encodings" "asdf" "asdf-driver")
  ...
  ("backports" "alexandria" "bordeaux-threads" "closer-mop"
   "trivial-backtrace")
  ("backports-test" "backports" "fiveam") ("base")
  ...
  ("big-string") ("binary-types") ("binascii")
  ("binascii-tests" "binascii") ("binge" "npg" "sclf")
  ...
  ("buildnode" "alexandria" "cl-interpol" "cl-ppcre" "closure-html"
   "cxml" "flexi-streams" "iterate" "split-sequence" "swank"
   "symbol-munger")
  ...
  ("cl-autorepo")
  ("cl-autowrap" "alexandria" "cffi" "cl-json" "cl-ppcre"
  ...
  ("cl-csv-test" "cl-csv" "lisp-unit") ("cl-ctrnn") ("cl-curlex")
  ...
  ("cl-glfw-types" "cffi") ("cl-glfw3" "cffi" "cffi-libffi")
  ...
  ("cl-growl" "flexi-streams" "ironclad" "trivial-utf-8"
   "usocket-udp")
  ("cl-gss" "cffi" "cffi-grovel" "trivial-garbage")
  ...
  ("cl-indeterminism" "cl-curlex" "hu.dwim.walker")
  ("cl-indeterminism-tests" "cl-indeterminism" "eos")
  ...
  ("cl-pdf-parser" "cl-pdf") ("cl-performance-tuning-helper")
  ...
  ("cl-rrt-test" "cl-rrt" "cl-test-more" "vecto")
  ...
  ("cl-secure-read" "defmacro-enhance" "iterate" "named-readtables"
   "rutils" "yaclanapht")
  ("cl-secure-read-test" "cl-secure-read" "rt")
  ("cl-sendmail" "cl-mime" "xmls" "xmls-tools")
  ("cl-sentiment" "cl-ppcre" "rt") ("cl-simple-table")
  ("cl-skip-list" "cffi")
  ...
  ("cl-string-complete") ("cl-string-match") ("cl-svg") ("cl-svm")
  ...
  ("cl-table" "iterate") ("cl-template")
  ("cl-template-tests" "cl-template" "fiveam")
  ...
  ("climacs" "flexichain" "mcclim") ("clinch" "cl-opengl")
  ...
  ("com.informatimago.xcode" "com.informatimago.common-lisp.cesarum"
   "com.informatimago.common-lisp.parser" "com.informatimago.rdp")
  ("command-line-arguments" "asdf-driver") ("comp-set")
  ...
  ("defcontract" "closer-mop") ("defdoc" "defcontract") ("deflate")
  ...
  ("epigraph" "alexandria") ("epigraph-test" "epigraph" "fiveam")
  ("epmd" "com.gigamonkeys.binary-data" "usocket")
  ("epmd-test" "epmd" "fiveam" "flexi-streams")
  ("erlang-term" "alexandria" "nibbles") ("esa" "mcclim")
  ...
  ("exscribe" "alexandria" "exscribe-typeset" "fare-memoization"
  ...
  ("function-cache-test" "function-cache" "lisp-unit")
  ...
  ("inferior-shell-test" "inferior-shell" "inferior-shell/test")
  ("infix") ("infix-dollar-reader" "cl-syntax")
  ...
  ("interface" "alexandria" "closer-mop" "fare-memoization"
   "fare-utils" "uiop")
  ("interface-transform" "pure-datastructures" "pure-interfaces"
   "stateful-datastructures" "stateful-interfaces")
  ...
  ("list-of" "asdf-finalizers") ("listoflist" "lift" "xarray")
  ...
  ("lowlight" "alexandria" "cl-ppcre" "cl-who" "spinneret")
  ("lowlight.doc" "cl-gendoc" "lowlight")
  ...
  ("macroexpand-dammit")
  ("macroexpand-dammit-test" "fiveam" "macroexpand-dammit")
  ("madeira-port") ("madeira-port-tests" "eos" "madeira-port")
  ("magicffi" "cffi" "cffi-grovel" "cl-ppcre")
  ("magicffi-test" "alexandria" "cffi-grovel" "magicffi")
  ("make-hash") ("make-hash-tests" "fiveam" "make-hash")
  ...
  ("mcclim" "clim-looks") ("mcclim-gif-bitmaps" "mcclim" "skippy")
  ...
  ("polling-functions") ("portable-sockets")
  ...
  ("rcl" "cffi" "trivial-garbage") ("rcl-test" "fiveam" "rcl")
  ("read-csv") ("read-csv.test" "read-csv") ("reader-interception")
  ...
  ("smtp4cl" "mime4cl" "net4cl") ("snmp" "ironclad" "usocket")
  ...
  ("weblocks" "anaphora" "bordeaux-threads" "cl-cont" "cl-fad"
   ...
   "trivial-backtrace" "trivial-timeout" "weblocks-stores"
   "weblocks-util")
  ...
  ("weblocks-test" "anaphora" "closer-mop" "f-underscore" "lift"
   "metatilities" "weblocks" "weblocks-store-test" "weblocks-stores")
  ("weblocks-tree-widget" "weblocks" "yaclml")
  ...
  ("weblocks-utils" "alexandria" "arnesi" "clache" "weblocks"
   "weblocks-custom" "weblocks-stores" "weblocks-tree-widget")
 ...
 (("3b-swf" . "3b-swf") ("3b-swf-swc" . "3b-swf")
  ...
  ("apply-argv" . "apply-argv") ("apply-argv-tests" . "apply-argv")
  ...
  ("base" . "gendl") ("beirc" . "beirc") ("bencode" . "cl-bencode")
  ("bencode-test" . "cl-bencode") ("bermuda" . "pal")
  ("bert" . "cl-bert") ("bibtex" . "cl-bibtex")
  ("big-string" . "big-string") ("binary-types" . "binary-types")
  ...
  ("cl-alut" . "cl-openal") ("cl-annot" . "cl-annot")
  ("cl-annot-test" . "cl-annot") ("cl-anonfun" . "cl-anonfun")
  ...
  ("cl-launch" . "cl-launch") ("cl-ledger" . "cl-ledger")
  ("cl-lex" . "cl-lex") ("cl-libevent2" . "cl-libevent2")
  ...
  ("cl-oauth.tests" . "cl-oauth")
  ("cl-one-time-passwords" . "cl-one-time-passwords")
  ("cl-one-time-passwords-test" . "cl-one-time-passwords")
  ("cl-op" . "cl-op") ("cl-openal" . "cl-openal")
  ("cl-openal-examples" . "cl-openal") ("cl-opengl" . "cl-opengl")
  ("cl-openid" . "cl-openid") ("cl-openid.test" . "cl-openid")
  ("cl-openstack" . "cl-openstack") ("cl-org-mode" . "cl-org-mode")
  ...
  ("cl-rrt" . "cl-rrt") ("cl-rrt-test" . "cl-rrt")
  ...
  ("cl-secure-read-test" . "cl-secure-read")
  ...
  ("cl-string-match" . "cl-string-match") ("cl-svg" . "cl-svg")
  ...
  ("cl-table" . "cl-table") ("cl-template" . "cl-template")
  ...
  ("clinch" . "clinch") ("clinch-cairo" . "clinch")
  ("clinch-freeimage" . "clinch") ("clinch-pango" . "clinch")
  ("clite" . "clite") ("clnuplot" . "clnuplot")
  ("clobber" . "clobber") ("clod" . "clod") ("clon" . "clon")
  ...
  ("consix" . "consix") ("contextl" . "contextl")
  ...
  ("defmacro-enhance" . "defmacro-enhance")
  ...
  ("drakma" . "drakma") ("drakma-test" . "drakma")
  ("drei-mcclim" . "mcclim") ("drei-tests" . "mcclim")
  ...
  ("eos-tests" . "eos") ("epigraph" . "epigraph")
  ("epigraph-test" . "epigraph") ("epmd" . "cl-epmd")
  ("epmd-test" . "cl-epmd") ("erlang-term" . "cl-erlang-term")
  ("esa" . "mcclim") ("esa-mcclim" . "mcclim")
  ("escalator" . "escalator") ("escalator-bench" . "escalator")
  ("esrap" . "esrap") ("esrap-peg" . "esrap-peg")
  ...
  ("fset" . "fset") ("ftp" . "cl-ftp") ("fucc-generator" . "fucc")
  ...
  ("lisp-matrix" . "lisp-matrix") ("lisp-unit" . "lisp-unit")
  ...
  ("log5" . "log5") ("logv" . "cl-couch") ("lowlight" . "lowlight")
  ("lowlight.doc" . "lowlight") ("lparallel" . "lparallel")
  ("lparallel-bench" . "lparallel") ("lparallel-test" . "lparallel")
  ("lquery" . "lquery") ("lredis" . "lredis") ("ltk" . "ltk")
  ("ltk-mw" . "ltk") ("ltk-remote" . "ltk")
  ...
  ("macroexpand-dammit-test" . "macroexpand-dammit")
  ...
  ("map-bind" . "map-bind") ("marching-cubes" . "marching-cubes")
  ("marching-cubes-example" . "marching-cubes")
  ...
  ("sexml" . "sexml") ("sexml-objects" . "sexml") ("sha3" . "sha3")
  ...
  ("skippy" . "skippy") ("smtp4cl" . "smtp4cl") ("snmp" . "snmp")
  ...
  ("synonyms" . "synonyms") ("ta2" . "gendl") ("talcl" . "talcl")
  ...
  ("wkb" . "cl-wkb") ("wu-decimal" . "wu-decimal")

...
(:SYSTEM->DEPENDENCIES
 (("3b-swf" "alexandria" "chipz" "cl-jpeg" "cxml" "flexi-streams"
  ...
  ("asdf-driver" "uiop") ("asdf-encodings" "asdf" "asdf-driver")
  ...
  ("buddens-readtable" "named-readtables") ("buildapp")
  ...
  ("cl-ana" "calculus" "clos-utils" "csv-table" "error-propogation"
   "file-utils" "fitting" "generic-math" "hdf-table" "histogram"
   "int-char" "linear-algebra" "lorentz" "math-functions"
   "ntuple-table" "package-utils" "pathname-utils" "plotting"
   "reusable-table" "serialization" "statistics" "table"
   "table-utils" "table-viewing" "tensor")
  ...
  ("cl-hooks" "alexandria" "closer-mop" "let-plus")
  ("cl-hooks-test" "cl-hooks" "lift") ("cl-html-diff" "cl-difflib")
  ("cl-html-parse") ("cl-html5-parser" "cl-ppcre" "flexi-streams")
  ...
  ("cl-indeterminism" "cl-curlex" "defmacro-enhance"
   "hu.dwim.walker")
  ...
  ("cl-lastfm-test" "cl-lastfm" "lift") ("cl-launch")
  ...
  ("cl-log") ("cl-log-test" "cl-log" "eos") ("cl-ltsv")
  ...
  ("cl-oauth.tests" "cl-oauth" "fiveam") ("cl-olefs" "ieee-floats")
  ...
  ("clos-utils" "list-utils" "symbol-utils") ("closer-mop")
  ...
  ("cls" "alexandria" "antik" "cl-variates" "data-format-validation"
   "fare-csv" "gsll" "lift" "lisp-matrix" "listoflist" "xarray")
  ...
  ("collectors-test" "collectors" "lisp-unit2") ("colnew" "f2cl")
  ...
  ("contextl" "closer-mop" "lw-compat") ("crypt") ("csound" "cffi")
  ("css-lite")
  ...
  ("darts.lib.hashtrie") ("darts.lib.ptree")
  ...
  ("data-table-clsql" "clsql" "clsql-helper" "collectors"
   "data-table" "iterate")
  ("data-table-test" "data-table" "lisp-unit") ("date-calc") ("db3")
  ...
  ("defcontract" "closer-mop") ("defdoc" "defcontract")
  ("define-json-expander") ("deflate")
  ("defmacro-enhance" "alexandria" "iterate")
  ...
  ("degree-symbol" "antik" "cl-unicode") ("delorean" "local-time")
  ...
  ("ernestine-tests" "ernestine" "lift")
  ...
  ("fare-quasiquote-test" "fare-quasiquote-optima" "hu.dwim.stefil")
  ("fare-utils")
  ...
  ("hctsmsl" "alexandria") ("hctsmsl-tests" "fiveam" "hctsmsl")
  ("hdf-cffi" "cffi")
  ...
  ("hinge" "alexandria" "arnesi" "bordeaux-threads" "closer-mop" "ev"
   "iolib" "log5" "uuid" "zmq")
  ("histogram" "alexandria" "clos-utils" "fitting" "generic-math"
   "iterate" "list-utils" "macro-utils" "map" "symbol-utils"
   "tensor")
  ...
  ("inferior-shell-test" "inferior-shell") ("infix")
  ...
  ("iolib" "babel" "bordeaux-threads" "idna" "swap-bytes"
   "split-sequence" "cffi" "alexandria" "trivial-features")
  ...
  ("lambda-reader-8bit" "asdf" "asdf-driver" "asdf-encodings"
   "named-readtables")
  ...
  ("macro-utils" "alexandria" "list-utils" "string-utils"
   "symbol-utils")
  ...
  ("manifest" "alexandria" "closer-mop" "monkeylib-html" "puri"
   "split-sequence" "toot")
  ("map") ("map-bind") ("map-set") ("marching-cubes")
  ...
  ("package-utils" "alexandria") ("paiprolog") ("pal" "cffi")
  ("pango" "cffi" "cl-cairo2") ("paren-files" "parenscript")
  ...
  ("plplot-examples" "cl-plplot") ("png" "cffi" "cffi-grovel")
  ("png-read" "babel" "chipz" "iterate") ("png-test" "png")
  ("pod-utils") ("policy-cond") ("polling-functions") ("pooler")
  ...
  ("sdl2-examples" "sdl2") ("secret-values")
  ...
  ("serialization" "hdf-table" "hdf-utils" "histogram" "typespec")
  ...
  ("statistics" "generic-math" "list-utils")
  ...
  ("weblocks-montezuma" "montezuma" "weblocks")
 ...
 (("3b-swf" . "3b-swf") ("3b-swf-swc" . "3b-swf")
  ...
  ("asdf-finalizers-test" . "asdf-finalizers") ("asdf-nst" . "nst")
  ...
  ("buddens-readtable" . "def-symbol-readmacro")
  ...
  ("cl-log-test" . "cl-log") ("cl-ltsv" . "cl-ltsv")
  ("cl-ltsv-test" . "cl-ltsv") ("cl-m4" . "cl-m4")
  ...
  ("cl-slice-tests" . "cl-slice") ("cl-smtp" . "cl-smtp")
  ("cl-spark" . "cl-spark") ("cl-speedy-queue" . "cl-speedy-queue")
  ...
  ("clinch-pango" . "clinch") ("clite" . "clite")
  ...
  ("colnew" . "f2cl") ("colnew-test-1" . "f2cl")
  ("colnew-test-2" . "f2cl") ("colnew-test-3" . "f2cl")
  ("colorize" . "colorize")
  ("com.clearly-useful.generic-collection-interface"
   . "com.clearly-useful.generic-collection-interface")
  ("com.clearly-useful.generic-collection-interface.test"
  ...
  ("degree-symbol" . "antik") ("delorean" . "delorean")
  ("delorean-test" . "delorean")
  ...
  ("hctsmsl" . "hctsmsl") ("hctsmsl-tests" . "hctsmsl")
  ("hdf-cffi" . "cl-ana") ("hdf-table" . "cl-ana")
  ("hdf-typespec" . "cl-ana") ("hdf-utils" . "cl-ana")
  ("helambdap" . "helambdap") ("hemlock" . "phemlock")
  ...
  ("lift-documentation" . "lift") ("lift-test" . "lift")
  ("lil" . "lisp-interface-library") ("linear-algebra" . "cl-ana")
  ...
  ("log5" . "log5") ("logv" . "cl-couch") ("lorentz" . "cl-ana")
  ...
  ("package-utils" . "cl-ana") ("paiprolog" . "paiprolog")
  ("pal" . "pal") ("pango" . "clinch")
  ...
  ("plplot-examples" . "cl-plplot") ("png" . "cl-png")
  ("png-read" . "png-read") ("png-test" . "cl-png")
  ("pod-utils" . "cells-gtk3") ("policy-cond" . "policy-cond")
  ("polling-functions" . "gbbopen") ("pooler" . "pooler")
  ("portable-sockets" . "gbbopen")
  ...
  ("scriptl-examples" . "scriptl") ("sdl2" . "cl-sdl2")
  ("sdl2-examples" . "cl-sdl2") ("secret-values" . "secret-values")
  ...
  ("smtp4cl" . "smtp4cl") ("snappy" . "snappy") ("snmp" . "snmp")
  ...
  ("swap-bytes" . "swap-bytes") ("swf-writer-hack" . "3bil")
  ...
  ("vgplot" . "vgplot") ("vgplot-test" . "vgplot")

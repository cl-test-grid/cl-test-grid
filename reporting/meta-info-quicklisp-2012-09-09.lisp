...
(:SYSTEM->DEPENDENCIES
 (("3b-swf" "alexandria" "chipz" "cl-jpeg" "cxml" "flexi-streams"
  ...
  ("acl-compat" "cl-ppcre" "puri") ("adw-charting" "iterate")
  ...
  ("archive" "trivial-gray-streams") ("arnesi") ("arnesi+")
  ...
  ("aromyxo" "alexandria" "bordeaux-threads" "cl-ppcre"
   ...
   "trivial-garbage")
  ("array-operations" "cffi" "cl-utilities" "iterate"
   "metabang-bind")
  ...
  ("asdf-install") ("asdf-nst") ("asdf-system-connections")
  ("asdf-utils") ("aserve" "acl-compat" "htmlgen")
  ...
  ("bencode" "flexi-streams") ("bermuda" "pal")
  ("bert" "alexandria" "cleric") ("bibtex" "split-sequence")
  ...
  ("btrie-tests" "btrie" "lift" "metabang-bind") ("buildapp")
  ...
  ("ch-image-test" "ch-image") ("chanl" "bordeaux-threads")
  ("chanl.examples" "chanl") ("checkl" "marshal")
  ...
  ("cl-apple-plist" "html-encode") ("cl-autorepo")
  ("cl-azure" "babel" "cl-base64" "cl-ppcre" "cxml" "drakma"
   "ironclad" "puri" "rt")
  ...
  ("cl-factoring-test" "cl-factoring" "cl-primality" "iterate"
   "stefil")
  ("cl-fad") ("cl-fastcgi" "cffi" "usocket") ("cl-fbclient" "cffi")
  ...
  ("cl-fsnotify" "cffi" "cffi-grovel") ("cl-gap-buffer")
  ("cl-gd" "uffi") ("cl-gd-test" "cl-gd")
  ...
  ("cl-lex" "cl-ppcre") ("cl-libusb" "libusb-ffi" "trivial-garbage")
  ...
  ("cl-mustache-test" "cl-fad" "cl-json" "cl-markup" "cl-mustache"
   "toot")
  ...
  ("cl-num-utils" "alexandria" "anaphora" "iterate" "let-plus")
  ("cl-num-utils-tests" "alexandria" "anaphora" "cl-num-utils"
   "iterate" "lift" "metabang-bind")
  ...
  ("cl-pattern-test" "cl-pattern" "cl-test-more")
  ...
  ("cl-syntax-markup" "cl-markup" "cl-syntax") ("cl-syslog" "uffi")
  ("cl-test-more" "cl-ppcre") ("cl-timing") ("cl-tk" "cffi")
  ("cl-tokyo-cabinet" "cffi" "deoxybyte-systems")
  ("cl-tokyo-cabinet-test" "cl-tokyo-cabinet" "deoxybyte-io"
   "deoxybyte-utilities" "lift")
  ("cl-tuples" "iterate") ("cl-tuples-test" "alexandria" "cl-tuples")
  ...
  ("clack" "alexandria" "anaphora" "bordeaux-threads"
   "circular-streams" "cl-fad" "cl-ppcre" "cl-syntax"
   "cl-syntax-annot" "flexi-streams" "ironclad" "local-time"
   "multival-plist" "rfc2388" "split-sequence" "trivial-types"
   "yason")
  ...
  ("clawk" "regex") ("clazy") ("clem") ("clem-benchmark" "clem")
  ("clem-test" "clem")
  ("cleric" "alexandria" "flexi-streams" "ieee-floats" "md5"
   "usocket")
  ...
  ("clpython.test" "clpython" "ptester") ("clsql" "uffi")
  ("clsql-aodbc") ("clsql-cffi" "clsql")
  ...
  ("coleslaw" "3bmd" "3bmd-ext-code-blocks" "alexandria" "cl-fad"
   "closure-template" "local-time" "trivial-shell")
  ...
  ("com.clearly-useful.sequence-protocol" "alexandria"
   "com.clearly-useful.protocols")
  ("com.dvlsoft.clon") ("com.dvlsoft.declt") ("com.dvlsoft.rcfiles")
  ("com.gigamonkeys.binary-data" "alexandria")
  ...
  ("coretest") ("crypt") ("csound" "cffi") ("css-lite")
  ...
  ("diff" "cl-ppcre" "trivial-gray-streams") ("dlist")
  ...
  ("enumerations") ("eos") ("eos-tests" "eos") ("esa" "mcclim")
  ...
  ("exscribe" "alexandria" "cl-launch" "cl-typesetting"
   "fare-matcher" "fare-memoization" "fare-utils" "scribble"
   "xcvb-driver")
  ...
  ("fare-quasiquote-readtable" "fare-matcher" "named-readtables")
  ("fare-utils" "asdf") ("fcgi" "trivial-gray-streams" "usocket")
  ...
  ("gdl-demos" "gdl-gwl-graphics") ("gdl-examples")
  ...
  ("gdl-ta2" "gdl-gwl-graphics")
  ("gdl-tasty" "gdl-gwl-graphics" "gdl-tree")
  ("gdl-tree" "gdl-gwl-graphics") ("gdl-yadd" "gdl-gwl-graphics")
  ("general-accumulator") ("genhash")
  ("genworks-gdl" "gdl-demos" "gdl-gwl-graphics" "gdl-ta2"
   "gdl-tasty" "gdl-yadd")
  ...
  ("ieee-floats-tests" "fiveam" "ieee-floats")
  ...
  ("inferior-shell" "alexandria" "asdf" "asdf-condition-control"
   "fare-matcher" "fare-mop" "fare-quasiquote-readtable" "fare-utils"
   "xcvb-driver")
  ...
  ("latex-table" "alexandria" "anaphora" "cl-num-utils" "iterate"
   "let-plus")
  ...
  ("m2cl-test" "fiveam" "m2cl") ("mach-par" "f2cl")
  ...
  ("method-versions") ("mgl" "closer-mop")
  ...
  ("moptilities-test" "lift" "moptilities") ("mpg123-ffi" "cffi")
  ...
  ("optima" "alexandria" "anaphora" "closer-mop")
  ...
  ("parse-js") ("parse-number") ("parse-number-tests" "parse-number")
  ("parseltongue" "lisp-unit")
  ("parser-combinators" "alexandria" "iterate")
  ("parser-combinators-cl-ppcre" "alexandria" "cl-ppcre" "iterate"
   "parser-combinators")
  ("parser-combinators-tests" "alexandria" "fare-matcher"
   "hu.dwim.stefil" "infix" "iterate" "parser-combinators")
  ("patron" "bordeaux-threads")
  ("pcall" "bordeaux-threads" "pcall-queue")
  ("pcall-queue" "bordeaux-threads") ("pcall-tests" "fiveam" "pcall")
  ("pcl-unit-test" "standard-cl") ("perfpiece" "alexandria" "cffi")
  ...
  ("s-base64") ("s-dot")
  ("s-http-client" "puri" "s-base64" "s-sysdeps" "s-utils")
  ("s-http-server" "puri" "s-base64" "s-sysdeps" "s-utils")
  ...
  ("scribble" "asdf-utils" "fare-matcher" "fare-memoization"
   "fare-quasiquote-readtable" "fare-utils" "meta"
   "named-readtables")
  ...
  ("sexml" "alexandria" "cl-ppcre" "contextl" "cxml"
   "macroexpand-dammit")
  ("sexml-objects" "sexml") ("shadchen") ("sheeple")
  ...
  ("stp-query" "alexandria" "anaphora" "arnesi" "cl-interpol"
   ...
   "yacc")
  ("streaming") ("string-case") ("stumpwm" "cl-ppcre" "clx")
  ...
  ("unix-options")
  ("until-it-dies" "until-it-dies.base" "until-it-dies.graphics"
   "until-it-dies.sound")
  ("until-it-dies.base" "alexandria" "cl-opengl" "glop")
  ("until-it-dies.examples" "until-it-dies")
  ("until-it-dies.graphics" "cl-devil" "cl-glu" "until-it-dies.base"
   "zpb-ttf")
  ...
  ("vcs-tree") ("vecto" "cl-vectors" "zpb-ttf" "zpng")
  ...
  ("xcvb" "asdf" "asdf-condition-control" "asdf-dependency-grovel"
   ...
   "fare-matcher" "fare-memoization" "fare-mop"
   "fare-quasiquote-readtable" "inferior-shell" "ironclad"
   "lambda-reader" "lisp-interface-library" "rucksack"
   "xcvb-bootstrap" "xcvb-driver" "xcvb-utils")
  ...
  ("xcvb-test" "cl-ppcre" "hu.dwim.stefil" "inferior-shell" "xcvb"
   "xcvb-driver-test")
  ("xcvb-utils" "alexandria" "asdf" "asdf-utils" "fare-utils"
   "xcvb-driver")
  ...
  ("yason" "alexandria" "trivial-gray-streams") ("zcdb")
 ...
 (("3b-swf" . "3b-swf") ("3b-swf-swc" . "3b-swf")
  ...
  ("access" . "access") ("access-test" . "access")
  ("acl-compat" . "portableaserve") ("adw-charting" . "adw-charting")
  ...
  ("anaphora-test" . "anaphora") ("antik" . "antik")
  ...
  ("backports" . "backports") ("beirc" . "beirc")
  ("bencode" . "cl-bencode") ("bermuda" . "pal") ("bert" . "cleric")
  ("bibtex" . "cl-bibtex") ("binary-types" . "binary-types")
  ("binascii" . "binascii") ("binascii-tests" . "binascii")
  ("binge" . "binge") ("binomial-heap" . "binomial-heap")
  ...
  ("cl-btree-0.5" . "cl-btree") ("cl-buchberger" . "cl-buchberger")
  ("cl-cairo2" . "cl-cairo2") ("cl-cairo2-demos" . "cl-cairo2")
  ("cl-cairo2-gtk2" . "cl-cairo2") ("cl-cairo2-xlib" . "cl-cairo2")
  ("cl-charms" . "cl-charms") ("cl-cheshire-cat" . "cl-cheshire-cat")
  ("cl-colors" . "cl-colors") ("cl-cont" . "cl-cont")
  ...
  ("cl-fsnotify" . "cl-fsnotify") ("cl-gap-buffer" . "cl-gap-buffer")
  ("cl-gd" . "cl-gd") ("cl-gd-test" . "cl-gd")
  ("cl-gdata" . "cl-gdata") ("cl-gendoc" . "cl-gendoc")
  ...
  ("cl-hooks" . "cl-hooks") ("cl-hooks-test" . "cl-hooks")
  ("cl-html-diff" . "cl-html-diff")
  ("cl-html-parse" . "cl-html-parse") ("cl-i18n" . "cl-i18n")
  ...
  ("cl-libusb" . "cl-libusb") ("cl-libxml2" . "cl-libxml2")
  ("cl-libxml2-test" . "cl-libxml2") ("cl-locale" . "cl-locale")
  ("cl-locale-syntax" . "cl-locale") ("cl-log" . "cl-log")
  ("cl-log-test" . "cl-log") ("cl-m4" . "cl-m4")
  ("cl-m4-test" . "cl-m4") ("cl-markdown" . "cl-markdown")
  ...
  ("cl-neo4j.tests" . "cl-neo4j") ("cl-num-utils" . "cl-num-utils")
  ...
  ("cl-pattern-benchmark" . "cl-pattern")
  ("cl-pattern-test" . "cl-pattern") ("cl-paypal" . "cl-paypal")
  ...
  ("cl-sendmail" . "cl-sendmail") ("cl-skip-list" . "cl-skip-list")
  ("cl-smtp" . "cl-smtp") ("cl-speedy-queue" . "cl-speedy-queue")
  ...
  ("cl-test-more" . "cl-test-more") ("cl-timing" . "gbbopen")
  ("cl-tk" . "cl-tk") ("cl-tokyo-cabinet" . "cl-tokyo-cabinet")
  ("cl-tokyo-cabinet-test" . "cl-tokyo-cabinet")
  ("cl-tuples" . "cl-tuples") ("cl-tuples-test" . "cl-tuples")
  ("cl-tuples-tests" . "cl-tuples") ("cl-twit-repl" . "cl-twitter")
  ("cl-twitter" . "cl-twitter") ("cl-typesetting" . "cl-typesetting")
  ...
  ("clesh" . "clesh") ("clesh-tests" . "clesh") ("clfswm" . "clfswm")
  ("clhs" . "clhs") ("cli-parser" . "cl-cli-parser")
  ("clickr" . "clickr") ("clim" . "mcclim") ("clim-basic" . "mcclim")
  ...
  ("clpython.test" . "clpython") ("clsql" . "clsql")
  ...
  ("contextl" . "contextl") ("coretest" . "coretest")
  ("crypt" . "cl-crypt") ("csound" . "sqnc")
  ...
  ("diff" . "diff") ("dlist" . "dlist") ("dlist-test" . "dlist")
  ...
  ("elf" . "elf") ("enumerations" . "cl-enumeration") ("eos" . "eos")
  ("eos-tests" . "eos") ("esa" . "mcclim") ("esa-mcclim" . "mcclim")
  ("escalator" . "escalator") ("escalator-bench" . "escalator")
  ("esrap" . "esrap") ("esrap-tests" . "esrap") ("ev" . "cl-ev")
  ("evol" . "evol") ("evol-test" . "evol") ("exscribe" . "exscribe")
  ("ext-blog" . "ext-blog")
  ("extensible-sequences" . "sequence-iterators")
  ...
  ("fare-mop" . "fare-mop")
  ("fare-quasiquote-readtable" . "fare-matcher")
  ("fare-utils" . "fare-utils") ("fcgi" . "fcgi")
  ("femlisp" . "femlisp") ("femlisp-basic" . "femlisp")
  ("femlisp-matlisp" . "femlisp") ("ffa" . "ffa") ("fft" . "fft")
  ...
  ("gdl-examples" . "genworks-gdl")
  ("gdl-geom-base" . "genworks-gdl") ("gdl-gwl" . "genworks-gdl")
  ("gdl-gwl-graphics" . "genworks-gdl") ("gdl-ta2" . "genworks-gdl")
  ("gdl-tasty" . "genworks-gdl") ("gdl-tree" . "genworks-gdl")
  ("gdl-yadd" . "genworks-gdl")
  ("general-accumulator" . "cl-general-accumulator")
  ("genhash" . "genhash") ("genworks-gdl" . "genworks-gdl")
  ("geo" . "cl-geo") ("getopt" . "getopt")
  ("getopt-tests" . "getopt") ("glaw" . "glaw")
  ...
  ("group-by" . "group-by") ("group-by-test" . "group-by")
  ("gsharp" . "gsharp") ("gsll" . "gsll") ("gtfl" . "gtfl")
  ("gtk-cffi-utils" . "gtk-cffi") ("gtk-ffi" . "cells-gtk3")
  ("gzip-stream" . "gzip-stream") ("hemlock" . "phemlock")
  ...
  ("incf-cl-test" . "incf-cl") ("inferior-shell" . "inferior-shell")
  ...
  ("inotify" . "inotify") ("interface" . "lisp-interface-library")
  ...
  ("latex-table" . "latex-table") ("leech" . "bknr-web")
  ("let-plus" . "let-plus") ("let-plus-tests" . "let-plus")
  ("letrec" . "letrec") ("levenshtein" . "levenshtein")
  ("lexer" . "cl-lexer") ("lhstats" . "lhstats")
  ("libusb-ffi" . "cl-libusb") ("lift" . "lift")
  ("lift-documentation" . "lift") ("lift-test" . "lift")
  ("lil" . "lisp-interface-library") ("linedit" . "linedit")
  ...
  ("mach-par" . "f2cl") ("macroexpand-dammit" . "macroexpand-dammit")
  ...
  ("moptilities-test" . "moptilities") ("mpg123-ffi" . "mixalot")
  ("mssql" . "cl-mssql") ("mt19937" . "mt19937")
  ("mtlisp" . "mtlisp") ("multinode" . "gbbopen")
  ...
  ("optima" . "optima") ("org-davep-dict" . "org-davep-dict")
  ...
  ("parse-float" . "parse-float") ("parse-js" . "parse-js")
  ...
  ("portable-threads-test" . "gbbopen") ("postmodern" . "postmodern")
  ("postoffice" . "postoffice") ("prepl" . "prepl")
  ("printf" . "printf") ("printf.test" . "printf")
  ("priority-queue" . "priority-queue") ("proc" . "cl-proc")
  ("protobuf" . "protobuf") ("psgraph" . "psgraph")
  ("ptester" . "ptester") ("pubmed" . "pubmed")
  ...
  ("scribble-test" . "scribble") ("secure-random" . "secure-random")
  ("selenium" . "cl-selenium")
  ...
  ("simple-finalizer" . "simple-finalizer") ("simpsamp" . "simpsamp")
  ...
  ("string-case" . "string-case") ("stumpwm" . "stumpwm")
  ...
  ("until-it-dies.examples" . "until-it-dies")
  ("until-it-dies.graphics" . "until-it-dies")
  ...
  ("vas-string-metrics" . "vas-string-metrics")
  ("vcs-tree" . "vcs-tree") ("vecto" . "vecto")
  ...
  ("yaclml" . "yaclml") ("yason" . "yason") ("zcdb" . "zcdb")
